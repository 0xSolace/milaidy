...
const CHAIN_MAP: Record<number, ChainMeta> = {
  ...
  97: { name: "BSC Testnet", symbol: "tBNB", explorerBase: "https://testnet.bscscan.com" },
  137: { name: "Polygon", symbol: "POL", explorerBase: "https://polygonscan.com" },
  8453: { name: "Base", symbol: "ETH", explorerBase: "https://basescan.org" },
  42161: { name: "Arbitrum", symbol: "ETH", explorerBase: "https://arbiscan.io" },
  84532: { name: "Base Sepolia", symbol: "ETH", explorerBase: "https://sepolia.basescan.org" },
  101: { name: "Solana", symbol: "SOL", explorerBase: "https://solscan.io" },
  102: { name: "Solana Devnet", symbol: "SOL", explorerBase: "https://solscan.io" },
};
