  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <SectionCard
          title="Diagnostics"
          description="Version, window, display, clipboard, and path state from the desktop shell."
          className="rounded-2xl [&>div:first-child]:border-b-0"
        >
        ...
        <SectionCard
          title="Detached Surfaces"
          description="Launch the native Electrobun surfaces without navigating away from the main shell."
          className="rounded-2xl [&>div:first-child]:border-b-0"
        >
          <div className="space-y-3">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <SectionCard
          ...
          description="Control the main desktop window directly from settings."
          className="rounded-2xl [&>div:first-child]:border-b-0"
        >
          <div className="space-y-3">
        ...
        <SectionCard
          title="Lifecycle"
          description="Restart the backend, relaunch the app, or toggle auto-launch behavior."
          className="rounded-2xl [&>div:first-child]:border-b-0"
        >
          <div className="space-y-3">
            <div className="flex flex-wrap gap-2">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <SectionCard
          ...
          description="Test file, folder, and save dialogs and inspect the returned paths."
          className="rounded-2xl [&>div:first-child]:border-b-0"
        >
          <div className="space-y-3">
            <div className="flex flex-wrap gap-2">
        ...
        <SectionCard
          ...
          description="Read, clear, and write clipboard text, then open or reveal saved paths."
          className="rounded-2xl [&>div:first-child]:border-b-0"
        >
          <div className="space-y-3">
            <textarea
