  ...
  if (!isAuthenticated()) {
    return (
      <div className="flex flex-col items-center justify-center py-20 animate-fade-up">
        ...
        <h3 className="text-base font-medium text-text-light mb-1.5">Not connected</h3>
        <p className="text-sm text-text-muted">Sign in with Eliza Cloud to view credits.</p>
      </div>
    );
  }
