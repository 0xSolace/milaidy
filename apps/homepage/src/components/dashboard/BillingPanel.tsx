...
export function BillingPanel() {
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center py-32 space-y-3">
        <div className="text-text-muted/30 text-4xl">{"\u25C8"}</div>
        <div className="text-text-muted font-mono text-sm">Billing data unavailable</div>
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <h3 className="font-mono text-xs uppercase tracking-widest text-brand">Billing & Usage</h3>
      ...
      <div className="bg-dark border border-white/10 rounded p-4">
        ...
        <div className="text-text-light font-mono text-lg mt-1">{cloudAgents.length} active</div>
      </div>

      {/* Billing Settings */}
      {billingSettings && (
        <div className="bg-dark border border-white/10 rounded p-4">
          <div className="text-text-muted font-mono text-[10px] uppercase tracking-wider mb-2">Settings</div>
