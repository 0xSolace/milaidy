    ...
    >
      ...
      {canOpenUI && uiUrl && (
        ...
        >
          ...
          Open Web UI
          <svg className="w-3 h-3 opacity-0 group-hover/ui:opacity-100 transition-opacity" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex items-center gap-2 ml-3 flex-shrink-0">
            <span className={`w-2 h-2 rounded-full ${stateConfig.bg} ${agent.state === "provisioning" ? "status-dot-pulse" : ""}`} />
        ...
        <div className="flex flex-wrap items-center gap-x-5 gap-y-1.5 text-xs text-text-muted mb-4">
          ...
          {lastHeartbeat && (
            <span className="flex items-center gap-1.5" title={`Last heartbeat: ${new Date(lastHeartbeat).toLocaleString()}`}>
              <svg className="w-3.5 h-3.5 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {createdAt && (
            <span className="flex items-center gap-1.5" title={`Created: ${new Date(createdAt).toLocaleString()}`}>
              <svg className="w-3.5 h-3.5 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
