/**
 * Audio playback with real-time volume analysis for lip sync.
 *
 * Plays WAV/audio buffers through Web Audio API and provides a smoothed
 * volume value (0–1) that drives the avatar's mouth animation.
 */
