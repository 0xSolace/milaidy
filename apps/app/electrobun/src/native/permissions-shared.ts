export type { SystemPermissionId, PermissionStatus, Platform, SystemPermissionDefinition, PermissionState, PermissionCheckResult } from "@miladyai/app-core/contracts/permissions";
import type { SystemPermissionId, Platform, SystemPermissionDefinition, PermissionState } from "@miladyai/app-core/contracts/permissions";
