...
Pre-built Docker images are now published to GitHub Container Registry on every release. Pull `ghcr.io/milady-ai/agent` to deploy without building from source. See the [deployment guide](/deployment) for Docker Compose setup and environment variables.
